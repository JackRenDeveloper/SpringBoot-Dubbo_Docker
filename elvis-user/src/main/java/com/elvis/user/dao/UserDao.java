package com.elvis.user.dao;

import com.elvis.entity.user.*;
import com.elvis.req.user.LocationUpdateReq;
import com.elvis.req.user.RoleMenuReq;
import com.elvis.req.user.RolePermissionReq;
import com.elvis.req.user.UserQueryReq;
