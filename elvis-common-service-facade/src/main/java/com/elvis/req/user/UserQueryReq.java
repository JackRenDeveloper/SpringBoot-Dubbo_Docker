package com.elvis.req.user;

import com.elvis.req.QueryReq;
...
public class UserQueryReq extends QueryReq {
    ...
    /** 用户类型 {@link com.elvis.enumeration.user.UserTypeEnum} */
    private Integer userType;

    /** 账号状态 {@link com.elvis.enumeration.user.UserStateEnum } */
    ...
    /** 根据注册时间排序 {@link com.elvis.enumeration.OrderEnum} */
